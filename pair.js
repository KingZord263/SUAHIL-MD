        ...
        try {
            ...
            MalvinTechInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'SUHAIL-XMD~'+ stringSession;  // Prepend your name to the session ID
                    ...
                    await MalvinTechInc.sendMessage(userJid, { text: `Hey there, SUHAIL User!* 👋🏻

Thanks for using *SUHAIL* — your session has been successfully created!
